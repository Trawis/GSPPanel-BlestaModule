...
$lang['PterodactylPackage.!error.meta[players].format'] = 'Please set the maximum number of player slots to allow.';
$lang['PterodactylPackage.!error.meta[memory].format'] = 'Please set the maximum amount of memory as an integer in MB.';
$lang['PterodactylPackage.!error.meta[jardir].format'] = 'Please select a valid JAR directory.';
$lang['PterodactylPackage.!error.meta[user_jar].format'] = 'Whether the owner can select the JAR must be set to 1 or 0.';
$lang['PterodactylPackage.!error.meta[user_name].format'] = 'Whether the owner can set a name must be set to 1 or 0.';
$lang['PterodactylPackage.!error.meta[user_schedule].format'] = 'Whether the owner can schedule tasks must be set to 1 or 0.';
$lang['PterodactylPackage.!error.meta[user_ftp].format'] = 'Whether the owner can give FTP access to others must be set to 1 or 0.';
$lang['PterodactylPackage.!error.meta[user_visibility].format'] = 'Whether the owner can change the server visibility must be set to 1 or 0.';
$lang['PterodactylPackage.!error.meta[default_level].format'] = 'Please select a valid Default Role.';
$lang['PterodactylPackage.!error.meta[autostart].format'] = 'Whether the server should automatically start must be set to 1 or 0.';
$lang['PterodactylPackage.!error.meta[create_ftp].format'] = 'Whether to create an FTP account must be set to 1 or 0.';
$lang['PterodactylPackage.!error.meta[server_visibility].format'] = 'Please select a valid Server Visibility.';
